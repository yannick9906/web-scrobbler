 ...
 * @param  {Function} [onClick] Function that will be called on notification click
 */
export async function showNowPlaying(song, onClick) {
	if (!await isAllowed()) {
		return;
	}
 ...
 */
export function clearNowPlaying(song) {
	clearNotificationTimeout();
 ...
 * @param  {Function} [onClick] Function that will be called on notification click
 */
export function showSignInError(scrobbler, onClick) {
 ...
 * @param  {Function} [onClick] Function that will be called on notification click
 */
export async function showSongNotRecognized(song, onClick) {
 ...
 */
export async function showAuthNotification(onClicked) {
	const options = {
